...
It must contain VecA = [1,2,3,4,5] and a 5 x 5 zero matrix.
```{r}
VecA <- c(1,2,3,4,5)
...
female_sub <- subset(accessData, Gender == "F")
female_sub
```
...
```{r}
library(readxl)
alexa_file <- read_excel("File ALxa.xlsx")
alexa_file
```
...
png("TPlot.png")
dev.off()
knitr::include_graphics("/cloud/project/Worksheet 4/Rworksheet_4b/TPlot.png")
...
png("BlkWht_Plot.png")
dev.off()
knitr::include_graphics("/cloud/project/Worksheet 4/Rworksheet_4b/BlkWht_Plot.png")
